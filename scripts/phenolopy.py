...
def create_ds_template(da):
    ...
    temp_ds = xr.Dataset({
        'pos_v': temp_da.astype('float32'),
        #'pos_t': temp_da.astype('int16'),
        #'bse_v': temp_da.astype('float32'),
        #'bse_t': temp_da.astype('int16'),
        #'sos_v': temp_da.astype('float32'),
        #'sos_t': temp_da.astype('int16'),
        #'eos_v': temp_da.astype('float32'),
        #'eos_t': temp_da.astype('int16'), 
        #'aos_v': temp_da.astype('float32'),
        #'los_t': temp_da.astype('int16'), 
        #'rog_v': temp_da.astype('float32'),
        #'rob_v': temp_da.astype('float32'),
        #'lios_v': temp_da.astype('float32'),
        #'sios_v': temp_da.astype('float32'),
        #'lit_v': temp_da.astype('float32'),
        #'sit_v': temp_da.astype('float32')
    })
